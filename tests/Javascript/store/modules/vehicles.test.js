import module, { _getItemPath } from '~/store/modules/vehicles'
...
describe('vehicles Store', () => {
  ...
  test('item url', () => {
    expect(_getItemPath({ id: 1 })).toEqual('/sales/v1/vehicles/1')
    expect(_getItemPath({ id: 3 })).toEqual('/sales/v1/vehicles/3')
  })
})
