import module, { _getItemPath } from '~/store/modules/customers'
...
describe('customers Store', () => {
  ...
  test('item url', () => {
    expect(_getItemPath({ id: 1 })).toEqual('/sales/v1/customers/1')
    expect(_getItemPath({ id: 3 })).toEqual('/sales/v1/customers/3')
  })
})
